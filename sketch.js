...
function setup() {
  ...
  wall1=createSprite(50,320,10,430);
  wall2=createSprite(90,340,90,10);
  wall3=createSprite(138,285,8,120);
  wall4=createSprite(550,245,10,190);
  wall5=createSprite(495,340,120,10);
  wall6=createSprite(380,340,60,10);
  wall7=createSprite(300,340,60,10);
  wall8=createSprite(220,340,60,10);
  wall9=createSprite(220,430,10,190);
  wall10=createSprite(210,530,35,10);
  wall11=createSprite(60,530,35,10);
  wall12=createSprite(410,530,160,10);
  wall13=createSprite(300,380,10,70);
  ...
  bigHero6.addImage("yo",stoop);
  bigHero6.addAnimation("wp",left);
  bigHero6.addAnimation("gg",right);
  bigHero6.scale=0.05;
  knife=createSprite(1000,140,20,20);
  knife.addImage("bablu",knifeImage);
  knife.scale=0.1;
  pig=createSprite(1000,140,20,20);
  pig.addImage("mango",pigImage);
  pig.scale=0.3;
  ball=createSprite(1000,150,10,10);
  cactus=createSprite(1000,480,20,20);
  cactus.addImage("falnu nahi",cactusImage);
  cactus.scale=0.3;
  enemy=createSprite(1000,480,20,20);
  enemy.addImage("pig",enemyImage);
  enemy.scale=0.3;
  escapePod=createSprite(1000,430,20,20);
  escapePod.addImage("win",spaceShipImage);
  escapePod.scale=0.1;
}
...
function draw() {
  ...
  if(keyIsDown(RIGHT_ARROW)){
    bigHero6.x+=5;
    bigHero6.changeAnimation("gg",right);
  }
  if(keyIsDown(LEFT_ARROW)){
    bigHero6.x=bigHero6.x-5;
    bigHero6.changeAnimation("wp",left);
  }
